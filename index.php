...
<header>
    ...
    <div class="header-bottom">
        <ul class="flex">
            <li><a hreh="#">Introduzione</a></li>
            <li><a hreh="#">Norme sulla Privacy</a></li>
            <li><a hreh="#">Termini di servizio</a></li>
            <li><a hreh="#">Tecnologie</a></li>
            <li class="active"><a hreh="#">Domande frequenti</a></li>
        </ul>
    </div>
</header>
    ...
    <div class="container">
        ...
        <?php
            foreach ($questions as $question) {
                ...
                echo '<h2>' . $question['domanda'] . '</h2>';
                echo '<p>' . nl2br($question['risposta']) . '</p>';
